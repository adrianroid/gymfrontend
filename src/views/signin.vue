      ...
      <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
        <div class="px-5 py-7 pb-3">
          ...
          <button 
            @click="login"            
            type="button"
            class="transition duration-200 bg-blue-500 hover:bg-blue-600 focus:shadow-sm text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block"
          >
